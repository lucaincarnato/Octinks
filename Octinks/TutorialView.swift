    ...
    var body: some View {
        ...
        GeometryReader { geometry in
            ZStack {
                ...
                // Onboarding's text
                VStack {
                    Text("Squeeze the Apple Pencil Pro\nor tap with three fingers\nto delete all the litter")
                        .font(.system(size: 50))
                        .multilineTextAlignment(.center)
                        .foregroundStyle(Color.accentColor)
                        .bold()
                        .padding(.vertical, 10)
                    Text("(only when the ink is full, it will consume all of it)")
                        .font(.system(size: 30))
                        .multilineTextAlignment(.center)
                        .foregroundStyle(Color.black.opacity(0.3))
                        .bold()
    ...
    var body: some View {
        ...
        GeometryReader { geometry in
            ZStack {
                ...
                // Onboarding's text
                VStack{
                    Text("Hover the Apple Pencil Pro\nor drag with two fingers to move")
                        .font(.system(size: 50))
                        .multilineTextAlignment(.center)
                        .foregroundStyle(Color.accentColor)
                        .bold()
                        .padding(.vertical, 10)
                    Text("(with the Apple Pencil Pro don't touch the screen)")
                        .font(.system(size: 30))
                        .multilineTextAlignment(.center)
                        .foregroundStyle(Color.black.opacity(0.3))
                        .bold()
